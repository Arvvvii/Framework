...
@section('title', 'Ras Hewan Management')
                            ...
                            <tbody>
                                @forelse($rashewans as $rh)
                                    <tr class="align-middle">
                                        ...
                                        <td>{{ $rh->nama_ras }}</td>
                                        <td>{{ $rh->nama_jenis_hewan ?? 'N/A' }}</td>
                                        <td>
                                            <a href="{{ route('admin.rashewan.edit', $rh->idras_hewan) }}" class="btn btn-sm btn-warning">
                                                <i class="bi bi-pencil-square"></i> Edit
                                            </a>
                                            <form action="{{ route('admin.rashewan.destroy', $rh->idras_hewan) }}" method="POST" style="display:inline;" onsubmit="return confirm('Yakin ingin menghapus data ini?');">
                                                @csrf
                                                @method('DELETE')
