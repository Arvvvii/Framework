...
<div class="container">
    ...
    <form action="{{ route('admin.kodeterapi.store') }}" method="post">
        @csrf
        ...
        <div class="mb-3">
            ...
            <input type="text" name="deskripsi_tindakan_terapi" id="deskripsi_tindakan_terapi" value="{{ old('deskripsi_tindakan_terapi') }}" class="form-control">
        </div>
